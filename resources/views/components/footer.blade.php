    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row justify-between items-center">
            <div class="mb-4 md:mb-0">
                <a href="/" class="text-2xl font-bold text-brand tracking-tight">
                    Bite Rewards
                </a>
                <p class="mt-2 text-sm text-gray-500">Loyalty made simple and beautiful.</p>
            </div>
        ...
        <div class="mt-8 border-t border-gray-100 pt-8 md:flex md:items-center md:justify-between">
            <div class="flex space-x-6 md:order-2">
                <a href="#" class="text-base text-gray-400 hover:text-gray-900">Privacy Policy</a>
                <a href="#" class="text-base text-gray-400 hover:text-gray-900">Terms of Service</a>
                <a href="#" class="text-base text-gray-400 hover:text-gray-900">Contact</a>
            </div>
