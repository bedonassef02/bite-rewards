<footer class="bg-white/80 backdrop-blur-md border-t border-gray-100 mt-auto">
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
            
            <!-- Left: Copyright & Brand -->
            <div class="flex items-center text-gray-500">
                <span class="font-bold text-brand mr-1">Bite Rewards</span>
            ...
            <div class="flex space-x-4">
                <a href="#" class="text-gray-400 hover:text-brand transition-colors p-1 hover:bg-orange-50 rounded-full">
